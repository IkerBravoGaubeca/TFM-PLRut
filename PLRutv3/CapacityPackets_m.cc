...
void CapacityPacket::copy(const CapacityPacket& other)
{
    ...
    this->omnetIndex = other.omnetIndex;
...
void CapacityPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->omnetIndex);
...
void CapacityPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->omnetIndex);
...
int CapacityPacket::getOmnetIndex() const
{
    return this->omnetIndex;
}

void CapacityPacket::setOmnetIndex(int omnetIndex)
{
    handleChange();
    this->omnetIndex = omnetIndex;
}
...
unsigned int CapacityPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_omnetIndex
...
int CapacityPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "omnetIndex") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "currentEdge") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "destinationEdge") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "routeEdges") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "arrived") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "hasNewRoute") == 0) return baseIndex + 7;
    if (strcmp(fieldName, "wait") == 0) return baseIndex + 8;
    if (strcmp(fieldName, "newRouteEdges") == 0) return baseIndex + 9;
...
std::string CapacityPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_omnetIndex: return long2string(pp->getOmnetIndex());
...
void CapacityPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_omnetIndex: pp->setOmnetIndex(string2long(value)); break;
...
omnetpp::cValue CapacityPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_omnetIndex: return pp->getOmnetIndex();
...
void CapacityPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_omnetIndex: pp->setOmnetIndex(omnetpp::checked_int_cast<int>(value.intValue())); break;
